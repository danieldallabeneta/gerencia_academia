...
import { atualizaEquipamentoApi, obterEquipamentoApi} from '../Api/Service';
...
const EquipamentoDetalhes = () => {
    ...
    const { id } = useParams();
    useEffect(() => obterEquipamento(id), [id]);

    function obterEquipamento(id) {
        obterEquipamentoApi(id)
    ...
    function carregaDados(resposta) {
        ...
        const stringComPonto = dados.valor.toString().replace(".",",");
        setValorAquisicao(stringComPonto);
    }
    ...
    const handleSubmit = async (e) => {
        ...
        const stringComPonto = valorAquisicao.replace(".","");
        const stringComVirgula = stringComPonto.replace(",",".");
        const equipamento = {
            id: codigo,
            nome: nome,
            tipo: parseInt(tipo),
            ...
            valor: parseFloat(stringComVirgula),
            descricao: descricao,
            loja: idLoja
        };
        console.log(equipamento);
        await atualizaEquipamentoApi(equipamento);
